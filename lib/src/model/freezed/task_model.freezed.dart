...
abstract class $TaskModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String titulo, String descricao, String prioridade});
}
...
class _$_TaskModel implements _TaskModel {
  ...
  @override
  String toString() {
    return 'TaskModel(id: $id, titulo: $titulo, descricao: $descricao, prioridade: $prioridade)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, titulo, descricao, prioridade);
...
abstract class _TaskModel implements TaskModel {
  const factory _TaskModel(
      ...
      required final String prioridade}) = _$_TaskModel;
